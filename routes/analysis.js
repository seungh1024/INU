...
router.route('/')// orders/로 get방식일 때
 ...
 .post(async(req,res,next)=>{
     if(req.body.Method == "Analysis"){
        ...
        var Nick = req.body.Nick;//body의 Nick을 읽어온 것
   ...
   //------------------연도별------------------------------
               ...
               try{
                   var YearMoney = await Analysis.findAll({
                      where:{
                       ...
                       attributes:[
                           [Sequelize.literal('SUM(Menu_price*Cnt)'),'Money']
                       ]
       ...
       //Nick 이 가게인 경우 -> Nick을 조회조건에 포함시켜 조회함
       async function OtherMoneyYear(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           if(startMonth<10){
               startMonth = '0'+startMonth
           }
       ...
       //Nick이 가게외의 다른 주문인 경우를 조회함ㅁ Nick외의 것들을 조회
       async function OtherMenuYear(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           if(startMonth<10){
               startMonth = '0'+startMonth
           }
   ...
   //-----------월별-------------------------------------
       ...
       //Nick 으로 조회함. Nick 에 해당하는 값들을 조회조건에 포함시켜 조회 ->그 가게의 데이터만뽑아오는 것
       async function OtherMoneyMonth(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           if(startDay<10){
               startDay = '0'+startDay
           }
       ...
       async function OtherMenuMonth(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           if(startDay<10){
               startDay = '0'+startDay
           }
   ...
   //---------------일별-----------------------------------
       ...
       //Nick으로 해당 가게에서 주문한 데이터만 조회함
       async function OtherMoneyDay(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           var firstDay = '';//날짜 쿼리에 들어갈 변수
           var firstYear = startYear;
           while(startYear<=endYear){
       ...
       //Nick이 아닌 -> 가게외의 주문만 조회함
       async function OtherMenuDay(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           var firstDay = '';//날짜 쿼리에 들어갈 변수
           var firstYear = startYear;
           while(startYear<=endYear){
   ...
   //-----------------시간별--------------------------------    
       ...
       //Nick 으로 해당 가게에서의 주문 데이터만 조회
       async function OtherMoneyClock(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           var firstDay = '';//날짜 쿼리에 들어갈 변수
           var firstYear = startYear;
           while(startYear<=endYear){
       ...
       //Nick 외의 주문 데이터만 조회 -> 가게외부에서의 주문 데이터 조회
       async function OtherMenuClock(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick){
           var Total = '[';
           var firstDay = '';//날짜 쿼리에 들어갈 변수
           var firstYear = startYear;
           while(startYear<=endYear){
        ...
        //inout값이 1인 것만
           ...
           if(gubun2 === 'Money'){//토탈금액 반환
               if(gubun1 === 'Year'){//연도별
                   OtherMoneyYear(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
   
               }
               else if(gubun1 === 'Month'){//월별
                   //gubun3이 store이므로 other 값을 1로 세팅
                   OtherMoneyMonth(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
               }
               else if(gubun1 === 'Day'){//일별
                   OtherMoneyDay(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
               }
               else{//시간별
                   OtherMoneyClock(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
               }
           }
           else{//메뉴주문량 반환
               if(gubun1 === 'Year'){//연도별
                   OtherMenuYear(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
               }
               else if(gubun1 === 'Month'){//월별
                   //gubun3이 store이므로 other 값을 1로 세팅
                   OtherMenuMonth(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
               }
               else if(gubun1 === 'Day'){//일별
                   OtherMenuDay(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick);
               }
               else{//시간별
                   OtherMenuClock(startYear,endYear,startMonth,endMonth,startDay,endDay,code,Nick)
               }
           }
        }
        //앱주문
